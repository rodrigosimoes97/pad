...
export const WORSHIP_PRESETS: Record<WorshipPresetName, PresetDefinition> = {
  ...
  'elevation-style': { label: 'Atmospheric Worship C', layers: { warm: 0.62, shimmer: 0.62, choir: 0.55, low: 0.36 }, motion: 'deep', reverbType: 'cathedral', reverbMix: 0.57, reverseAtmosphere: 'medium', reverseMix: 0.19, reverseTone: 0.45, reversePreDelay: 'medium', reverseWidth: 0.76, reverseDucking: true, brightness: 1.18, envelope: { attack: 2.3, release: 5.6 }, stereoWidth: 0.8 },
  'prayer-pad': { label: 'Prayer Pad', layers: { warm: 0.76, shimmer: 0.34, choir: 0.58, low: 0.3 }, motion: 'slow', reverbType: 'church', reverbMix: 0.5, reverseAtmosphere: 'medium', reverseMix: 0.18, reverseTone: 0.36, reversePreDelay: 'medium', reverseWidth: 0.62, reverseDucking: true, brightness: 0.92, envelope: { attack: 2.4, release: 5.4 }, stereoWidth: 0.63 },
  'soaking-pad': { label: 'Soaking Pad', layers: { warm: 0.65, shimmer: 0.66, choir: 0.72, low: 0.24 }, motion: 'deep', reverbType: 'ambient', reverbMix: 0.62, reverseAtmosphere: 'medium', reverseMix: 0.2, reverseTone: 0.42, reversePreDelay: 'long', reverseWidth: 0.74, reverseDucking: true, brightness: 1.08, envelope: { attack: 3.2, release: 6 }, stereoWidth: 0.84 },
  ...
  'deep-night': { label: 'Deep Night Pad', layers: { warm: 0.6, shimmer: 0.2, choir: 0.4, low: 0.66 }, motion: 'slow', reverbType: 'cathedral', reverbMix: 0.47, reverseAtmosphere: 'light', reverseMix: 0.16, reverseTone: 0.28, reversePreDelay: 'long', reverseWidth: 0.58, reverseDucking: true, brightness: 0.78, envelope: { attack: 2.1, release: 5 }, stereoWidth: 0.52 },
  'bright-air': { label: 'Bright Worship Air', layers: { warm: 0.45, shimmer: 0.82, choir: 0.5, low: 0.2 }, motion: 'medium', reverbType: 'ambient', reverbMix: 0.55, reverseAtmosphere: 'light', reverseMix: 0.15, reverseTone: 0.62, reversePreDelay: 'short', reverseWidth: 0.82, reverseDucking: false, brightness: 1.3, envelope: { attack: 1.8, release: 4.6 }, stereoWidth: 0.85 },
};
